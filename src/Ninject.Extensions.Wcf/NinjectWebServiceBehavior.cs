...
namespace Ninject.Extensions.Wcf
{
    ...
    /// </summary>
    public class NinjectWebServiceBehavior : IServiceBehavior
    {
        /// <summary>
        ...
        public NinjectWebServiceBehavior(Func<Type, IInstanceProvider> instanceProviderFactory, IDispatchMessageInspector requestScopeCleanUp)
        {
